    ...
    try {
      ...
      if (file != null) {
        ...
        if (_docFile.lengthSync() / 1000000 >
          ...
          error =
          'Max File Size ${observer.maxFileSizeAllowedInMB}MB\n\nSelected File Size ${(_docFile.lengthSync() / 1000000).round()}MB';
      ...
      HelperFunctions.toast('Cannot Send this Document type');
        ...
        child: new Row(
            ...
            children: <Widget>[
              _buildActionButton(new Key('retake'), Icons.add, () {
                HelperFunctions.checkAndRequestPermission(Platform.isIOS
