...
class Wait_receive extends StatefulWidget {
  @override
  _Wait_receive createState() => _Wait_receive();
}

class _Wait_receive extends State<Wait_receive> with TickerProviderStateMixin {
  int status = 2;
  var bloc;
