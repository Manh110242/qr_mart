...
class New_order_fragment extends StatefulWidget {
  @override
  _new_order_fragment createState() => _new_order_fragment();
}

class _new_order_fragment extends State<New_order_fragment>
  ...
  void initState() {
    ...
    _sc.addListener(() async {
      if (_sc.position.pixels == _sc.position.maxScrollExtent) {
        ...
        _page++;
        await bloc.getProductByListCategoryHome(status, _page, false);
        setState(() {
          load = false;
        });
      }
        ...
        return (snapshot.hasData && snapshot.data.length > 0)
            ...
            : Align(
                ...
                child: (snapshot.data == null)
                    ...
                    : Text('Không Có đơn hàng nào mới.'));
      },
    );
  }
}
