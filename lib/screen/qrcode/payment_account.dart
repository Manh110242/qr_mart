...
class PaymentAccount extends StatefulWidget {
  ...
  PaymentAccount(this.token);

  @override
  _PaymentAccount createState() => _PaymentAccount(this);
}

class _PaymentAccount extends State<PaymentAccount> {
  PaymentAccount paymentAccount;

  _PaymentAccount(this.paymentAccount);
              ...
              Padding(
                  ...
                  child: StreamBuilder(
                    ...
                    builder: (_context, snap) => TextField(
                      ...
                      decoration: new InputDecoration(
                        hintText: "Nhập số OV cần chuyển",
                        hintStyle:
                                  ...
                                  Flexible(
                                    ...
                                    child: Text(
                                      snapshot.data['fee_tranpost'] != null
                                          ? snapshot.data['fee_tranpost']['value_text']
                                          : '0đ',
                                      overflow: TextOverflow.ellipsis,
                                      maxLines: 2,
                                      style: TextStyle(
  ...
  payment() async {
    ...
    String money = (int.parse(_moneyController.text) * 1000).toString();
