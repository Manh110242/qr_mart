...
class _UpdateAddressShopState extends State<UpdateAddressShop> {
  ...
  getData(){
    ...
    quan.text = widget.item.district_name;
    phuong.text = widget.item.ward_name;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Cập nhật địa chỉ doanh nghiệp"),
      ),
