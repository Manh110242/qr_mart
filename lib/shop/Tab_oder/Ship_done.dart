...
class ShipDoneShop extends StatefulWidget {
  Function onClick;
  Function onCancel;
  ShipDoneShop({this.onClick,this.onCancel});
  @override
  _ShipDoneShop createState() => _ShipDoneShop();
}

class _ShipDoneShop extends State<ShipDoneShop> with TickerProviderStateMixin {
  String status = "order_delivering";
  var bloc;
