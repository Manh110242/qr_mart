...
class New_order_shop extends StatefulWidget {
  Function onClick;
  Function onCancel;
  New_order_shop({this.onClick,this.onCancel});

  @override
  _New_order_shop createState() => _New_order_shop();
}

class _New_order_shop extends State<New_order_shop>
    with TickerProviderStateMixin {
  String status = "order_waiting_process";
