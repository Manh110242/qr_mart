                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Lưu ý: Giá chỉ áp dụng khi không nhập giá bán buôn và bỏ trống ứng với giá "'"Liên hệ"'".",
                          style:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RichText(
                          ...
                          maxLines: 5,
                          text: TextSpan(
                            text: 'Bạn có thể chỉnh sửa ảnh hiển thị trên trang  đẹp hơn',
                            style: TextStyle(
                                color: Colors.black, fontSize: 16),
                            children: [
                              TextSpan(
                                text: " (*) (ảnh từ 500x500 đến 2000x2000 và nhỏ hơn 10MB)",
                                style: TextStyle(
                                  color: Colors.red,
                                  fontSize: 16,
                                ),
                                      ...
                                      InkWell(
                                        onTap: (){
                                          ...
                                          if(imgs.length <8){
                                            ...
                                            showToast("Tối đa 8 ảnh cho 1 sản phẩm", context, Colors.grey, Icons.error_outline);
                                            setState(() {
                                              errimage = true;
                                            });
                                          }
                                      ...
                                      InkWell(
                                        onTap: (){
                                          ...
                                          if(imgs.length <8){
                                            ...
                                            showToast("Tối đa 8 ảnh cho 1 sản phẩm", context, Colors.grey.shade300, Icons.error_outline);
                                            setState(() {
                                              errimage = true;
                                            });
                                          }
                        ...
                        onPressed: () async{
                          ...
                          if (_formKey.currentState.validate()) {
                             if(imgs.length>0 || images.length >0){
                               ...
                               var res = await bloc.updatePrd(imgs, name.text, description.text, price.text, radio,categoryid,iddel,widget.item.id);
                               if(res != null){
                                 if(res['code'] == 1){
                                   Navigator.pop(context, res);
                                   showToast("Đã cập nhật thành công sản phẩm", context, Colors.green, Icons.check);
                                   errimage = false;
                                   setState(() {});
                                 }else{
                                   showToastErr("Lỗi dữ liệu", context, Colors.red, Icons.error_outline);
                                 }
                               }else{
        ...
        children: List.generate(images.length + imgs.length, (index) =>Container(
          ...
          child: Column(
            children: [
              ...
              RadioListTile(value: index, groupValue: radio, onChanged: (value){
                radio = value;
                setState(() {});
              },title: Text("Ảnh đại diện", style: TextStyle(fontSize: 14),),)
            ],
          ),
        )),
      ),
